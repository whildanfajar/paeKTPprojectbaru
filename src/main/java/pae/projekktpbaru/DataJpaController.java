...
import pae.projekktpbaru.exceptions.NonexistentEntityException;
import pae.projekktpbaru.exceptions.PreexistingEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("pae_projekktpbaru_jar_0.0.1-SNAPSHOTPU");
